...
This repository is distributed under mixed licensing:

- Source code, including HTML, CSS, and JavaScript files, is licensed under the [MIT License](LICENSE).
- Ticket photographs in `tickets/` are licensed under the [Creative Commons Attribution 4.0 International License (CC BY 4.0)](LICENSE-CC-BY-4.0).
